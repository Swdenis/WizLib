...
{
    public partial class ManyToManyBookAuthor : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookAuthorAuthor_Id = table.Column<int>(type: "int", nullable: true),
                    BookAuthorBook_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.BookAuthorAuthor_Id, x.BookAuthorBook_Id },
